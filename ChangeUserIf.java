...
public class ChangeUserIf extends JFrame{
    /* Panel */
    ...
    /* Button */
    JButton joinBtn = new JButton("Change PWD");
    JButton cancelBtn = new JButton("Cancel");

    Main o = null;

    ChangeUserIf(Main _o) {
        o = _o;
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            /* 가입해 */
                ...
                if(uid.equals("") || upass.equals("")) {
                    ...
                    System.out.println(o.db.changeCheck(uid, upass));
                    System.out.println("Change pw Succeeded");
                    JOptionPane.showMessageDialog(null, "Change pw Succeeded");
                    dispose();
